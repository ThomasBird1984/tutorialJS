...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<form class="navbar-form navbar-left" role="search">
			<div class="form-group tutorial-search">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#">Link</a></li>
				<li><a class="tutorial-restart" href="#"><span class="fa fa-refresh"></span> Restart tutorial</a></li>
				<li class="dropdown">
...
<div class="container-fluid">
	...
	<div class="col-sm-2 tutorial-sidebar-navigation">
	...
	<div class="col-sm-2">
		...
		<div class="panel panel-default widget">
			<div class="panel-body">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non, quas. Nesciunt culpa, eum vitae corrupti. Incidunt corporis, provident ad ipsa rem accusamus consequatur exercitationem, eius libero fuga harum voluptas distinctio.</p>
			</div>
			<div class="panel-footer tutorial-add-widget">
				<a href="#">Remove widget</a>
			</div>
		</div>
		...
		<div class="panel panel-default widget">
			...
			<div class="panel-footer tutorial-add-user">
